...
CONSTRUCTION_TEMPLATES = {
    "jeans": [
        (1, "Cut Pieces", "Cut all pattern pieces from shell and lining", "Auto Cutter", None),
        (2, "Fuse Waistband", "Apply interfacing to waistband", "Fusing Press", None),
        (3, "Sew Front Pockets", "Attach pocket bags to front panels", "Single Needle", "301"),
        (4, "Sew Coin Pocket", "Attach coin pocket to right front", "Single Needle", "301"),
        (5, "Sew Fly", "Construct fly with zipper", "Single Needle", "301"),
        (6, "Join Front Rise", "Sew front panels together at fly", "Single Needle", "301"),
        (7, "Sew Back Yoke", "Join back yoke to back panels", "Single Needle", "301"),
        (8, "Sew Back Pockets", "Topstitch back pockets to panels", "Single Needle", "301"),
        (9, "Join Back Rise", "Sew back panels together", "Single Needle", "301"),
        (10, "Sew Inseams", "Join front to back at inseams", "Serger", "504"),
        (11, "Sew Outseams", "Join front to back at outseams", "Flat Feller", "401"),
        (12, "Attach Waistband", "Sew waistband to body", "Single Needle", "301"),
        (13, "Buttonhole", "Create waistband buttonhole", "Buttonhole Machine", None),
        (14, "Set Rivets", "Set pocket rivets", "Rivet Machine", None),
        (15, "Hem", "Hem leg openings", "Chain Stitch", "401"),
        (16, "Bartack", "Bartack stress points", "Bartack Machine", None),
        (17, "Press", "Final press", "Steam Press", None),
        (18, "QC Inspect", "Quality control inspection", None, None),
        (19, "Label & Tag", "Attach labels and hang tags", None, None),
    ],
    "shirts": [
        (1, "Cut Pieces", "Cut all pattern pieces", "Auto Cutter", None),
        (2, "Fuse Collar/Cuffs", "Apply interfacing", "Fusing Press", None),
        (3, "Sew Collar", "Construct collar assembly", "Single Needle", "301"),
        (4, "Sew Yoke", "Attach front/back yoke", "Single Needle", "301"),
        (5, "Sew Shoulder Seams", "Join front to back", "Serger", "504"),
        (6, "Set Sleeves", "Attach sleeves to body", "Serger", "504"),
        (7, "Sew Side Seams", "Close side seams", "Serger", "504"),
        (8, "Attach Collar", "Set collar to neckline", "Single Needle", "301"),
        (9, "Sew Placket", "Construct front placket", "Single Needle", "301"),
        (10, "Buttonholes", "Create buttonholes", "Buttonhole Machine", None),
        (11, "Sew Cuffs", "Construct and attach cuffs", "Single Needle", "301"),
        (12, "Hem", "Hem shirt bottom", "Coverstitch", "406"),
        (13, "Press", "Final press", "Steam Press", None),
        (14, "QC Inspect", "Quality control", None, None),
    ],
    "denim_jackets": [
        (1, "Cut Pieces", "Cut shell and lining", "Auto Cutter", None),
        (2, "Fuse", "Apply interfacing to collar/facing", "Fusing Press", None),
        (3, "Sew Front Panels", "Construct front panels with pockets", "Single Needle", "301"),
        (4, "Sew Back Panel", "Construct back with yoke", "Single Needle", "301"),
        (5, "Join Shoulder Seams", "Sew shoulders", "Single Needle", "301"),
        (6, "Set Sleeves", "Attach sleeves", "Single Needle", "301"),
        (7, "Sew Side Seams", "Close sides", "Flat Feller", "401"),
        (8, "Construct Collar", "Build collar assembly", "Single Needle", "301"),
        (9, "Attach Collar", "Set collar to neckline", "Single Needle", "301"),
        (10, "Sew Facing", "Attach front facing", "Single Needle", "301"),
        (11, "Buttonholes", "Create buttonholes", "Buttonhole Machine", None),
        (12, "Cuff Construction", "Build and attach cuffs", "Single Needle", "301"),
        (13, "Waistband", "Attach adjustable waistband tabs", "Single Needle", "301"),
        (14, "Topstitch", "Final topstitching", "Single Needle", "301"),
        (15, "Press", "Final press", "Steam Press", None),
        (16, "QC Inspect", "Quality control", None, None),
    ],
}
...
class TechPackGenerator:
    ...
    def _generate_construction(self, tech_pack: TechPack, category: str) -> int:
        ...
        count = 0
        for op_num, op_name, desc, machine, stitch in template:
